...
export default async function Home() {
  ...
  const officeTableGroup = ['ban-chan-sat', 'ban-giam-doc', 'ban-hop', 'ban-nhan-vien', 'cum-ban','quay-le-tan']
        ...
        <article className={styles.aboutArticle}>
          <div className="container">
            <div className={styles.aboutContent}>
              <h2 className={styles.footerBrandTitle}>
                Nội Thất Hùng Ngọc - Uy tín tạo niềm tin
              </h2>
              <p>
                Tự hào là <strong>nhà phân phối</strong> nội thất văn phòng và sofa giá rẻ
                hàng đầu Hà Nội. Chúng tôi cam kết sản phẩm <strong>giá gốc tại kho</strong>,
                hỗ trợ vận chuyển nhanh và bảo hành dài hạn.
              </p>
            </div>
          </div>
        </article>
